...
var anwser = 0;
do {
    var inter = leitor.questionInt("How many goals inter did? ");
    var gremio = leitor.questionInt("How many goals gremio did? ");
    total++;
    if (inter > gremio) {
        winsInter++;
    }
...
if (winsInter > winsGremio) {
    console.log("Inter won more times than GrÊmio!");
}
